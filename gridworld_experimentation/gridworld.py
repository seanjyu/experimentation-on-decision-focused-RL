# This gridworld was originally created by Ken Arnold and Allen Schmaltz and was further adapted by Sean Yu
...
class GridWorld(gym.Env):
    ...
    def __init__(self, maze, reward_fn, terminal_markers='', action_error_prob=0, directions="NSEW", state_embedding='unflatten'):
        ...
        if state_embedding == 'unflatten':
            ...
            self.observation_space = spaces.Box(low=0, shape=(1,))
